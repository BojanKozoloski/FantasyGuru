...
namespace FantasyGuru.Controllers
{
    public class ManagerController : Controller
    {
        ...
        public ActionResult Squad(int id, int gameweek = 1)
        {
            ...
            manager.Team = fPLTeam.GetSquad(id, gameweek);
            PickR gwData = fPLTeam.GetGameweekData(id, gameweek);
        ...
        public ActionResult Compare(int myid, int oppid, int gameweek = 1)
        {
            ...
            me.Team = fpl.GetSquad(myid, gameweek);
            PickR myGwData = fpl.GetGameweekData(myid, gameweek);

            Manager opp = fpl.GetManager(oppid);
            opp.Team = fpl.GetSquad(oppid, gameweek);
            PickR oppGwData = fpl.GetGameweekData(oppid, gameweek);
